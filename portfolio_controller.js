document.addEventListener('DOMContentLoaded', () => {
    ...
    const albums = [
...

        {
            ...
            videoCount: 19,
            images: ["path/to/image3.jpg", "path/to/image4.jpg"],
            videos: ["/video (1).mp4", "/video (2).mp4", "/Down1.mp4", "/Down2.mp4", "/video (3).mp4", "/video (4).mp4", "/video (5).mp4", "/video (6).mp4", "/video (7).mp4", "/video (8).mp4", "/video (9).mp4", "/video (10).mp4", "/video (11).mp4", "/video (12).mp4", "/video (13).mp4", "/Down3.mp4", "/Down4.mp4", "/video (14).mp4", "/video (15).mp4"],
